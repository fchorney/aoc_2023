...
def find_number_and_idx(grid: list[list], row, col) -> None:
    ...
    part_numbers[row][idx_c] = int(number_str)


def get_part_number(grid: list[list], row, col) -> None:
    ...
    find_number_and_idx(grid, row, col)
...
part_sum = 0
for row, cols in part_numbers.items():
